...
joystick_interrupt::joystick_interrupt()
	: nh("~")
{
	sub_joy   = nh.subscribe("/joy",   10, &joystick_interrupt::joy_Callback, this);
	sub_twist = nh.subscribe("/twist", 10, &joystick_interrupt::twist_Callback, this);
	sub_bool  = nh.subscribe("/bool",  10, &joystick_interrupt::bool_Callback, this);
